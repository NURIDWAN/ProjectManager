        ...
        $this->presets = [
            'ac_maintenance' => [
                ...
                'fields' => [
                    ...
                    'ampere_input_count' => ['type' => 'select', 'options' => [1, 2, 3], 'required' => true],
                    ...
                    'freon_before' => ['type' => 'numeric', 'min' => 0, 'max' => 800, 'unit' => 'PSI', 'required' => false],
                    'freon_after' => ['type' => 'numeric', 'min' => 0, 'max' => 800, 'unit' => 'PSI', 'required' => false],
