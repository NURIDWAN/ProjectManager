...
## Authenticated Layout (`resources/js/Layouts/AuthenticatedLayout.tsx`)
App shell for logged-in users with responsive sidebar navigation, mobile drawer menu, bottom quick navigation, header with theme toggle, and user dropdown menu.
...
Layout for unauthenticated authentication pages (login, password reset) featuring a split screen with branding sidebar and content container.
